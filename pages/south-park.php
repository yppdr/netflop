      ...
      <section class="jumbotron text-center">
        <div class="container">
          <div class="embed-responsive embed-responsive-21by9">
            <iframe class="embed-responsive-item" width="50%"src="https://www.youtube.com/embed/aav9EyVjtWc" allowfullscreen></iframe>
          </div>
        </div>
...
<div class="text-center">
  <h1 >South Park, le film</h1>
  <small>De <span class="badge badge-secondary">Trey Parker</span> dans le genres <span class="badge badge-secondary">Comédie , Musical , Animation</span></small>
  <p></p>
  <p>LA GUERRE ENTRE LES ÉTATS-UNIS ET LE CANADA EST DÉCLARÉE... À CAUSE D'UN DESSIN ANIMÉ ! - Depuis qu'ils ont réussi à regarder un film canadien de Terrence et Philip interdit aux mineurs, Stan, Kyle, Cartman et Kenny ont décidé de faire partager leur nouveau vocabulaire à leurs petits camarades. Rapidement, les parents s'offusquent et la Maison Blanche attaque le gouvernement canadien, qui n'a pas apprécié l'arrestation de Terrence et Philip... Adaptation en long-métrage des aventures de Stan, Kyle, Cartman et Kenny, South Park, le film : Plus long, plus grand et pas coupé est un film d'animation provocateur, décalé, cruel et corrosif.</p>
</div>
  ...
  <div class="modal-dialog" role="document">
    ...
    <footer class="text-muted">
      <div class="container">
        ...
        <p>N'est pas un Copyright de  Yannis ou de Loic ! Peut etre de be<span class="bwb-color">W</span>eb !   &copy; be<span class="bwb-color">W</span> 2018 </p>
      </div>
    </footer>
