      ...
      <section class="jumbotron text-center">
        <div class="container">
          <div class="embed-responsive embed-responsive-21by9">
            <iframe class="embed-responsive-item" width="50%"src="https://www.youtube.com/embed/qdiVezWqn1o" allowfullscreen></iframe>
          </div>
        </div>
